...
$.getJSON(window.location.origin +'/dataprofile', function(res){
    ...
    $('#profile').prop('src', '/assets/'+res.data.picture)
})
                ...
                <div class="flex flex-col px-2">
                    ...
                    <div class="flex flex-wrap items-center justify-between px-2 mt-2">
                        ...
                        <div>
                            ...
                            <a href="/edit-foto"<span class="bi bi-pencil-square"></span></a>
                            <a href="/hapus/${x.id}"<span class="bi bi-trash3 text-red-800"></span></a>
                        </div>
                    </div>
                </div>
            </div>
